...
def _sid_operators():
    return _load_json("sid_operators_json", SID_OPERATOR_JSON_PATH, SIDOperator)
...
sid_operators = partial(_get, _sid_operators, "sid_operators", _build_list_index, 0)
